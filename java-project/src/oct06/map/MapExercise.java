...
public class MapExercise {
    static void mapPut (HashMap map) {
        ...
        map.put("오세아",	"JAVA-GIT-TEST/src at main · seop93/JAVA-GIT-TEST");
    ...
    public static void main(String[] args) {
        ...
        mapPut(map);
        System.out.println("맵의 게수는 "+ map.size() + "개 입니다.");

        System.out.println(map.get("조예지"));
    }
}
